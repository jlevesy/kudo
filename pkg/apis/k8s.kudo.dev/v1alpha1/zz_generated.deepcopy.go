...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EscalationTargetSpec) DeepCopyInto(out *EscalationTargetSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EscalationTargetSpec.
func (in *EscalationTargetSpec) DeepCopy() *EscalationTargetSpec {
	if in == nil {
		return nil
	}
	out := new(EscalationTargetSpec)
	in.DeepCopyInto(out)
	return out
}
