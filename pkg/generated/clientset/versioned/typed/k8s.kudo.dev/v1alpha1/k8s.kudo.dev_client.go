...
type K8sV1alpha1Interface interface {
	...
	EscalationsGetter
	EscalationPoliciesGetter
}

// K8sV1alpha1Client is used to interact with features provided by the k8s.kudo.dev group.
type K8sV1alpha1Client struct {
	restClient rest.Interface
}

func (c *K8sV1alpha1Client) Escalations() EscalationInterface {
	return newEscalations(c)
}

func (c *K8sV1alpha1Client) EscalationPolicies() EscalationPolicyInterface {
	return newEscalationPolicies(c)
}
